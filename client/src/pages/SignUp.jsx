...
import { Mail, Lock, User, Eye, EyeOff, Film, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="flex justify-center items-center space-x-2 mb-4">
            ...
            <span className="text-4xl font-bold gradient-text">ReelPrompt</span>
          </div>
          <h2 className="text-3xl font-bold text-white">Create your account</h2>
          <p className="mt-2 text-gray-400">Join ReelPrompt and discover amazing movies</p>
        </div>
